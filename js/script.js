...
next_btn.onclick = () => {
  if (que_count < questions.length - 1) {
    //si el número de preguntas es menor que la longitud total de la pregunta
...
function showQuetions(index) {
  ...
  for (var i = 0; i < questions[index].imagen.length; i++) {
    imagenesHTML += "<img src='" + questions[index].imagen[i] + "'>";
  }
